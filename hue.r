...
if exists? %hue-config.r [
    hue-config: load %hue-config.r
    if error? try [
...
if none? hue-config/uuid [
    hue-config/uuid: makeUUID
]

if none? hue-config/bridge-id [
...
hue: make object! [
    lights: scenes: groups: schedules: sensors: rules: config: none
]
...
hue/config: config: make object! [
    ...
    whitelist: make object! [
        ...
        M0CzaTFkQWn284908SmcTedeS3l7gBTZjscBMl3c: make object! [
            lastUseDate: "2017-01-29T14:40:18"
            createDate: "2017-01-29T14:40:18"
            name: "auto insert user"
        ]
